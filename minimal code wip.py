...
while True:
    ...
    time.sleep(0.15)
    print("\nThis Personal Requirement Planner help students like you manage your time by organizing requirements based on difficulty and due date while having fun.")
